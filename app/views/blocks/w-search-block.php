...
<div class="<?php echo $w_class ?>">
    <div class="w-search-block__b-search-form">
        <!-- b-search-form -->
        <form class="<?php echo $b_class ?>" action="/" method="get" accept-charset="utf-8">
            <input type="search" name="search" class="b-search-form__input" value="" placeholder="<?php _e('Search...', 'lolita') ?>" autofocus>
        </form>
        <!-- /b-search-form -->
    </div>
